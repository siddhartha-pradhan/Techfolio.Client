        ...
        return [
            {
                ...
                status: 'alive',
                description:
                    'The smartest one in the house and the true little mastermind of our pack. Zoey is alert, dramatic, affectionate, and always one step ahead of everyone else.',
                personality: ['Intelligent', 'Loyal', 'Protective', 'Sneaky'],
                favoriteActivities: [
                    'Digging up the garden',
                    'Running to alert everyone first',
                    'Coming to bed for pampering',
                ],
                image: '/images/zoey.jpg',
                signatureBehavior: 'Opens half-closed doors with her claws',
                dotaHeroEquivalent:
                    'Crystal Maiden - Calm, clever, protective, and quietly in control',
                specialMemory:
                    'She would sometimes bark just enough to send the others away, then come back to claim all the love for herself',
                dateJoined: '2016',
            },
            {
                id: 'lucy',
                ...
                passedAge: 8,
                description:
                    'Our beautiful spotted girl who filled the house with energy, presence, and love. Lucy was bold, open-hearted, and impossible to ignore. Forever in our hearts.',
                personality: ['Energetic', 'Playful', 'Loving', 'Bold'],
                favoriteActivities: [
                    'Running around with full confidence',
                    'Joining every bit of excitement',
                    'Being naughty in plain sight',
                    'Making the house feel alive',
                ],
                image: '/images/lucy.jpg',
                signatureBehavior: 'Was naughty in full public view',
                dotaHeroEquivalent:
                    'Phantom Assassin - Striking, unforgettable, and always full of presence',
                specialMemory:
            ...
            },
            {
                ...
                status: 'alive',
                description:
                    'Our newest chaos machine. Bambi is energetic, food-driven, dramatic, mischievous, and somehow manages to turn every object in the house into a potential chew toy.',
                personality: ['Curious', 'Energetic', 'Friendly', 'Chaotic', 'Mischievous'],
                favoriteActivities: [
                    'Chewing absolutely everything',
                    'Racing to greet me at the door',
                    'Starting alert barks and cat drama',
                    'Stealing the first chance at treats',
                ],
                image: '/images/bambi.jpg',
                signatureBehavior: 'Chewed everyone’s spectacles like a collector',
                dotaHeroEquivalent: 'Pudge - Loud, lovable, hungry, and always causing something',
                specialMemory:
                    'She chewed the spectacles of almost everyone in the house, including mine, my parents’, my sister’s, and even my uncle’s',
                dateJoined: '2024',
            },
        ];
    }
